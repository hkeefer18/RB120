...
class Human < Player
  def choose
    ...
    loop do
      ...
      break if Move::VALUES.include?(choice) ||
               Move::VALUES.values.include?(choice)

      puts 'Sorry, invalid choice.'
    end
    self.move = Move.new(Move::VALUES[choice] || choice)
  end
  ...
  def set_name
    ...
    loop do
      ...
      n = gets.chomp
      break unless n.strip.empty? || Computer::NAMES.include?(n)
...
module Personality
  ...
  def values_by_person(name)
    ...
    when 'Sonny' then Move::VALUES.values # random
    end
  end
end
